...
.. php:class:: CRUDEntityDefinition
    ...
    .. php:method:: __construct($table, $fields, $label, $localeLabels, $standardFieldLabels, CRUDServiceProvider $serviceProvider)
        ...
        :type $serviceProvider: CRUDServiceProvider
    ...
    .. php:method:: getServiceProvider()
        ...
        :returns: CRUDServiceProvider the service provider

    .. php:method:: setServiceProvider(CRUDServiceProvider $serviceProvider)
